...
public class CommunicationConstants
{
    ...
    public static final String GCM_SENDER_ID = "341143421214";
    ...
    public static final String GCM_API_KEY = "AIzaSyAJUK8ioj2HAOyDBKMTMJ80DDShn5UUDIQ";
    public static final String TEAM_NAME = "DeborahHo";
    public static final String PASSWORD = "patricia";
